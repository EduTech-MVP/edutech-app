class AppSpacing {
  ...
  static const double xxxxl = baseUnit * 12; // 48px
  static const double xxxxxl = baseUnit * 16; // 64px

  // Specific spacing values from design system
  ...
  // Gap constants for flex layouts
  ...
  static const double inputHeightTextarea = 64.0;
